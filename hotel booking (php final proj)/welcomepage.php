  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <button aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-bs-target="#navbarSupportedContent" data-bs-toggle="collapse" type="button"><span class="navbar-toggler-icon"></button></a>
        <ul class="navbar-nav ms-3 mb-1 mb-lg-0">
          ...
          <ul class="navbar-nav ms-2 mb-1 mb-lg-0">
            <a class="nav-link ms-2" href="login.php">         
            <button type="button" 
            ...
            <a class="nav-link ms-2" href="availability.php">         
            <button type="button" 
                    class="btn btn-outline-dark shadow-none me-lg-3 me-2\"
                    data-bs-toggle="modal" 
                    data-bs-target="#loginModal">
...
<!-- 
    <div class="header">
        <img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/358143171_797311398764381_7186354534269260011_n.png?_nc_cat=100&cb=99be929b-3346023f&ccb=1-7&_nc_sid=aee45a&_nc_ohc=8KiVIbysJ8QAX-3B4W8&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdQldkWqhtqK-7TnaaWG_mkHgKLVEOXYs5LfJtJzD1Rzxw&oe=64CB4980" alt="crimson" class="header">
    </div> -->
    ...
    <div class="button-container">
        ...
        if (isset($_SESSION['username'])) { // // User is logged in ?>                        
            <div class="dropdown">
                <!-- <button class="button"><img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/357693248_1621420345023061_5638785322511945787_n.png?stp=dst-png_p1080x2048&_nc_cat=111&cb=99be929b-3346023f&ccb=1-7&_nc_sid=aee45a&_nc_ohc=k3qIMEfK8j0AX9fY2r7&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdRRcP_opmecHHtPfkKmemmbhVFHKfBF_QyNliiPn5Wrsg&oe=64CB39AB" alt="Menu" class="picture-button"></button> -->
        ...
        <!-- <a href="availability.php" class="button"><img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/357982392_584515347150412_1041608469223179685_n.png?stp=dst-png_p1080x2048&_nc_cat=110&cb=99be929b-3346023f&ccb=1-7&_nc_sid=aee45a&_nc_ohc=xEOM0HLAYO0AX9AEp8U&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdQ93EmWrNQRHPXfQFXErpX91NFGd0GR1_dMP53mDu2xiA&oe=64CB5FE9" alt="Availability" class="picture-button"></a> -->
    </div>
